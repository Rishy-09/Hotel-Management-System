...
public class AddDriver extends JFrame implements ActionListener{
    ...
    AddDriver(){
        ...
        lblroomno.setBounds(60, 70, 200, 20);
        add(lblroomno);
        ...
        String [] statusOptions = new String[]{"Available", "Busy"};
        availablecombo = new JComboBox(statusOptions);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            String avail = (String) availablecombo.getSelectedItem();
